...
<!--navigation-->
  ...
  <!--Seperate container for all questions-->
    <div class="test-container">
        <div class="left">
            <div class="question-title"> Verbal Reasoning Multiple Choice Test</div>
    ...
    <div id="instruct-modal" class="instruct-modal">
        <div class="instruct-modal-content">
            ...
            <p><font size="3" color="#e01937"> Please read the following passage and attempt all questions shown
                below the passage in a scroll bar. There are a total of 10 questions available in this Comprehension.
            </font></p>
        </div>
    </div>
